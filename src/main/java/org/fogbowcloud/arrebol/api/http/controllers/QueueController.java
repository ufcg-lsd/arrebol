...
public class QueueController {
  ...
  public ResponseEntity<String> addJobToQueue(
      @PathVariable String queueId, @Valid @RequestBody JobSpec jobSpec) {
  ...
  public ResponseEntity<String> getJobFromQueue(
      @PathVariable String queueId, @PathVariable String jobId) {
  ...
  public ResponseEntity<Map<String, String>> addQueue(
      @RequestBody JobProcessorSpec jobProcessorSpec) {
  ...
  public ResponseEntity<?> addWorkers(
      @PathVariable String queueId, @RequestBody WorkerNode workerNode) {
