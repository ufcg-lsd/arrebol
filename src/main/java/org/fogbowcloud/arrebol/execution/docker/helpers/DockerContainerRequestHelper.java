...
public class DockerContainerRequestHelper {
  ...
  public String createContainer(String image, Map<String, String> requirements)
      throws DockerCreateContainerException, UnsupportedEncodingException {
  ...
  private String createContainerRequest(String endPoint, StringEntity body) {
    ...
    try {
      ...
      throw new DockerCreateContainerException(
          "Could not create container [" + this.containerName + "]: " + e.getMessage());
    }
  ...
  public void startContainer() throws DockerStartException {
    ...
    try {
      ...
      throw new DockerStartException(
          "Could not start container [" + this.containerName + "]: " + e.getMessage());
    }
  ...
  public void removeContainer() throws DockerRemoveContainerException {
    ...
    try {
      ...
      throw new DockerRemoveContainerException(
          "Could not remove container [" + this.containerName + "]: " + e.getMessage());
    }
  ...
  private StringEntity jsonCreateContainer(String image, Map<String, String> requirements)
