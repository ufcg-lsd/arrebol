...
public class TaskExecutionResult {
  ...
  /**
   * It returns the exit codes for the execution of the commands. When the @{link TaskExecutor} was
   * not able to execute the command, the exit code is {@link
   * TaskExecutionResult#UNDETERMINED_RESULT}.
   */
