...
public class K8sContainer {
  ...
  public K8sContainer args(List<String> args) {

    this.args = args;
    return this;
  }

  public K8sContainer addArgsItem(String argsItem) {
    if (this.args == null) {
  ...
  public K8sContainer command(List<String> command) {

    this.command = command;
    return this;
  }

  public K8sContainer addCommandItem(String commandItem) {
  ...
  public K8sContainer env(List<V1EnvVar> env) {

    this.env = env;
    return this;
  }

  public K8sContainer addEnvItem(V1EnvVar envItem) {
    if (this.env == null) {
  ...
  public K8sContainer envFrom(List<V1EnvFromSource> envFrom) {

    this.envFrom = envFrom;
    return this;
  }

  public K8sContainer addEnvFromItem(V1EnvFromSource envFromItem) {
  ...
  public K8sContainer image(String image) {
  ...
  public K8sContainer imagePullPolicy(String imagePullPolicy) {
  ...
  public K8sContainer lifecycle(V1Lifecycle lifecycle) {
  ...
  public K8sContainer livenessProbe(V1Probe livenessProbe) {
  ...
  public K8sContainer name(String name) {
  ...
  public K8sContainer ports(List<V1ContainerPort> ports) {

    this.ports = ports;
    return this;
  }

  public K8sContainer addPortsItem(V1ContainerPort portsItem) {
    if (this.ports == null) {
  ...
  public K8sContainer readinessProbe(V1Probe readinessProbe) {
  ...
  public K8sContainer resources(K8sResourceRequirements resources) {
  ...
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  public K8sResourceRequirements getResources() {
    return resources;
  }

  public void setResources(K8sResourceRequirements resources) {
    this.resources = resources;
  }

  public K8sContainer securityContext(V1SecurityContext securityContext) {
  ...
  public K8sContainer startupProbe(V1Probe startupProbe) {
  ...
  public K8sContainer stdin(Boolean stdin) {
  ...
  public K8sContainer stdinOnce(Boolean stdinOnce) {
  ...
  public K8sContainer terminationMessagePath(String terminationMessagePath) {
  ...
  public K8sContainer terminationMessagePolicy(String terminationMessagePolicy) {
  ...
  public K8sContainer tty(Boolean tty) {
  ...
  public K8sContainer volumeDevices(List<V1VolumeDevice> volumeDevices) {

    this.volumeDevices = volumeDevices;
    return this;
  }

  public K8sContainer addVolumeDevicesItem(V1VolumeDevice volumeDevicesItem) {
  ...
  public K8sContainer volumeMounts(List<V1VolumeMount> volumeMounts) {

    this.volumeMounts = volumeMounts;
    return this;
  }

  public K8sContainer addVolumeMountsItem(V1VolumeMount volumeMountsItem) {
  ...
  public K8sContainer workingDir(String workingDir) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    K8sContainer v1Container = (K8sContainer) o;
