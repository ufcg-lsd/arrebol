...
public class K8sConfiguration {
    ...
    public K8sConfiguration(Configuration configuration) throws Exception {
        ...
        Property<Double> capacity = configuration.getProperty(K8sConstants.JSON_WORKERS_CAPACITY_KEY);
	...
	private void checkK8sConfigurationProperties(Configuration configuration) throws Exception {
        ...
        Property<Double> capacity = configuration.getProperty(K8sConstants.JSON_CLUSTER_ADDRESS_KEY);
        Property<String> address = configuration.getProperty(K8sConstants.JSON_WORKERS_CAPACITY_KEY);
        

        if (address.getValue() == null || address.getValue().trim().isEmpty() || address.getValue().contains(":")) {
