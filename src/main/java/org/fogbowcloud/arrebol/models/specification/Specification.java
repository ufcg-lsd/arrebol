...
public class Specification implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, that.id) && Objects.equals(requirements, that.requirements);
  }
  ...
  public String toString() {
    return "Specification{" + "id='" + id + '\'' + ", requirements=" + requirements + '}';
  }

  public JSONObject toJSON() {
    try {
      JSONObject specification = new JSONObject();
      AppUtil.makeBodyField(
          specification,
          SpecificationConstants.REQUIREMENTS_MAP_STR,
