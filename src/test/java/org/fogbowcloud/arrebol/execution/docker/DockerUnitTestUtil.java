...
public class DockerUnitTestUtil {
  ...
  public static final String MOCK_TASK_SCRIPT_CONTENT =
      MOCK_COMMAND
          + "\n"
          + MOCK_COMMAND
          + "\n"
  ...
  public static final TaskExecutionResult MOCK_SUCCESS_TASK_EXECUTION_RESULT =
      new TaskExecutionResult(RESULT.SUCCESS, MOCK_EC_ARRAY);
  ...
  protected static DockerContainerResource mockDockerContainerResource() throws Exception {
    DockerContainerResource dockerContainerResource =
        Mockito.mock(DefaultDockerContainerResource.class);
