...
public class DockerExecutorHelperTest {
    ...
    public static void setup() throws IOException {
        ...
        badFormattedSameLineContent = getFileContent(
        ...
        badFormattedContent = getFileContent(
    ...
    public void testSendTaskScriptExecutor() throws Exception {
        ...
        Mockito
            .when(dockerCommandExecutor.executeCommand(Mockito.eq(expectedWriteTsExecutorCommand)))
    ...
    public void testFailCommandSendTaskScriptExecutor() throws Exception {
        ...
        Mockito.when(dockerCommandExecutor
            .executeCommand(Mockito.eq(expectedWriteTsExecutorCommand)))
    ...
    public void testGetEcFile() throws Exception {
        ...
        DockerExecutorHelper dockerExecutorHelper = Mockito
            .spy(new DockerExecutorHelper(taskScriptExecutorContent,
                workerDockerRequestHelper));
